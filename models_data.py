...
ARCHITECTURES = {
    "Lexis 1": {
        ...
        "details": {
            ...
            "Alternating Local / Global Layers": (
                "Layers alternate: even-indexed layers use the local SWA window, "
...
AVAILABLE_MODELS = {
    "Lexis1-TS-1M": {
        ...
        "swa_window_size": 256,
        "swa_pattern": "Even layers: local (w=256) · Odd layers: global (full context)",
    },
